...
func main() {
	...
	if err = writeOutput(msgs, *targetFile, *goPackageName, *protoPackageName); err != nil {
...
func writeOutput(msgs []*message, path string, goPackageName string, protoPackageName string) error {
